...
<html>
  <head>
    ...
    <title>Funded | Crowd Funding Platform</title>
  ...
  <body class="skin-green sidebar-mini">
    <div class="wrapper">
      ...
      <footer class="main-footer">
        <!-- Default to the left -->
       &copy; <strong>Funded </strong> - <?php echo date('Y'); ?> Developed By: <a href="https://felixitsolutions.com">Contilight Creative</a>
      </footer>
