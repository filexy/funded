  ...
  public function __construct( AdminSettings $settings, Request $request) {
    ...
    if(!$this->request->expectsJson()) {
      ...
      return response()->json([
          ...
          <input type="hidden" name="custom" value="id='.$this->request->campaign_id.'&fn='.$this->request->full_name.'&mail='.$this->request->email.'&cc='.$this->request->country.'&pc='.$this->request->postal_code.'&cm='.$this->request->comment.'&anonymous='.$this->request->anonymous.'&pl='.$this->request->input('_pledge', 0).'">
